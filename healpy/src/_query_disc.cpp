/* Generated by Cython 0.15.1 on Fri Dec 14 19:56:36 2012 */
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "query_disc") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  6: values[5] = PyTuple_GET_ITEM(__pyx_args, 5);
 ...
 */
    ...
    __pyx_v_hb.query_disc_inclusive(pointing(__pyx_v_v), __pyx_t_6, ((rangeset<int64> &)__pyx_v_pixset), __pyx_v_factor);
    goto __pyx_L8;
  }
  /*else*/ {
 ...
 */
    ...
    __pyx_v_hb.query_disc(pointing(__pyx_v_v), __pyx_t_6, ((rangeset<int64> &)__pyx_v_pixset));
  }
  __pyx_L8:;
...
static PyObject *__pyx_pf_6healpy_11_query_disc_1query_polygon(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "query_polygon") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  5: values[4] = PyTuple_GET_ITEM(__pyx_args, 4);
 ...
 */
    __pyx_v_hb.query_polygon_inclusive(((std::vector<pointing>)__pyx_v_vert), ((rangeset<int64> &)__pyx_v_pixset), __pyx_v_factor);
    goto __pyx_L10;
  }
  /*else*/ {
 ...
 *     return pixset_to_array(pixset)
 */
    __pyx_v_hb.query_polygon(((std::vector<pointing>)__pyx_v_vert), ((rangeset<int64> &)__pyx_v_pixset));
  }
  __pyx_L10:;
...
static PyObject *__pyx_pf_6healpy_11_query_disc_2query_strip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "query_strip") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 233; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  5: values[4] = PyTuple_GET_ITEM(__pyx_args, 4);
...
static PyObject *__pyx_pf_6healpy_11_query_disc_3boundary(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6healpy_11_query_disc_3boundary[] = "boundary(nside, pix, step=1, nest=False)\nReturns an array containing vectors to the boundary of\n    the nominated pixel.\n\n    The returned array has shape (3, 4*step), the elements of\n    which are the x,y,z positions on the unit sphere of the\n    pixel boundary.  In order to get vector positions for just\n    the corners, specify step=1.\n\n    Parameters\n    ----------\n    nside : int\n      The nside of the Healpix map.\n    pix : int\n      Pixel identifier\n    step : int, optional\n      Number of elements for each side of the pixel.\n    nest : bool, optional\n      if True, assume NESTED pixel ordering, otherwise, RING pixel ordering\n\n    Returns\n    -------\n    boundary : float, array\n      x,y,z for positions on the boundary of the pixel\n\n    Example\n    -------\n    # Get corners of HEALPixel 5 in nside=2, RINGS ordering.\n\n    >>> import healpy as hp\n    >>> import numpy as np\n    >>> nside = 2\n    >>> corners = hp.boundary(nside, 5)\n    >>> print corners\n    [[  2.44716655e-17   5.27046277e-01   3.60797400e-01   4.56398915e-17]\n     [  3.99652627e-01   5.27046277e-01   8.71041977e-01   7.45355992e-01]\n     [  9.16666667e-01   6.66666667e-01   3.33333333e-01   6.66666667e-01]]\n\n    # Now convert to phi,theta representation:\n\n    >>> hp.vec2ang(np.transpose(corners))\n    (array([ 0.41113786,  0.84106867,  1.23095942,  0.84106867]), array([ 1.57079633,  0.78539816,  1.17809725,  1.57079633]))\n    ";
static PyMethodDef __pyx_mdef_6healpy_11_query_disc_3boundary = {__Pyx_NAMESTR("boundary"), (PyCFunction)__pyx_pf_6healpy_11_query_disc_3boundary, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6healpy_11_query_disc_3boundary)};
static PyObject *__pyx_pf_6healpy_11_query_disc_3boundary(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_nside = 0;
  ...
  __Pyx_RefNannySetupContext("boundary");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "boundary") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
 ...
 */
  ...
  __pyx_v_hb.boundaries(__pyx_t_4, __pyx_t_5, ((std::vector<vec3> &)__pyx_v_bounds));
 ...
 */
  ...
  __pyx_t_9 = PyEval_CallObjectWithKeywords(__pyx_t_6, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_7)); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_9);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
    ...
    } else if (unlikely(__pyx_t_12 >= __pyx_bshape_0_out)) __pyx_t_1 = 0;
    if (unlikely(__pyx_t_13 >= (size_t)__pyx_bshape_1_out)) __pyx_t_1 = 1;
    ...
    *__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_out.buf, __pyx_t_12, __pyx_bstride_0_out, __pyx_t_13, __pyx_bstride_1_out) = (__pyx_v_bounds[__pyx_v_i]).x;
 ...
 */
    ...
    __pyx_t_1 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_bshape_0_out;
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_1 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_bshape_0_out)) __pyx_t_1 = 0;
    if (unlikely(__pyx_t_15 >= (size_t)__pyx_bshape_1_out)) __pyx_t_1 = 1;
    if (unlikely(__pyx_t_1 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_1);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 336; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_out.buf, __pyx_t_14, __pyx_bstride_0_out, __pyx_t_15, __pyx_bstride_1_out) = (__pyx_v_bounds[__pyx_v_i]).y;
 ...
 */
    ...
    __pyx_t_1 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_bshape_0_out;
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_1 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_bshape_0_out)) __pyx_t_1 = 0;
    if (unlikely(__pyx_t_17 >= (size_t)__pyx_bshape_1_out)) __pyx_t_1 = 1;
    if (unlikely(__pyx_t_1 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_1);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 337; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *__Pyx_BufPtrStrided2d(double *, __pyx_bstruct_out.buf, __pyx_t_16, __pyx_bstride_0_out, __pyx_t_17, __pyx_bstride_1_out) = (__pyx_v_bounds[__pyx_v_i]).z;
  }
 ...
 */
  ...
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 374; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6healpy_11_query_disc_query_disc, NULL, __pyx_n_s_26); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6healpy_11_query_disc_1query_polygon, NULL, __pyx_n_s_26); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6healpy_11_query_disc_2query_strip, NULL, __pyx_n_s_26); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 233; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6healpy_11_query_disc_3boundary, NULL, __pyx_n_s_26); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);

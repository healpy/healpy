...
def mollview(map=None,fig=None,rot=None,coord=None,unit='',
    ...
    See Also
    --------
    gnomview, cartview, orthview, lambview, azeqview
    """
    # Create the figure
    import pylab
    if not (hold or sub):
...
def gnomview(map=None,fig=None,rot=None,coord=None,unit='',
    ...
    See Also
    --------
    mollview, cartview, orthview, lambview, azeqview
    """
    import pylab
    if not (hold or sub):
...
def cartview(map=None,fig=None,rot=None,zat=None,coord=None,unit='',
    ...
    See Also
    --------
    mollview, gnomview, orthview, lambview, azeqview
    """
    import pylab
    if not (hold or sub):
        f=pylab.figure(fig,figsize=(8.5,5.4))
...
def orthview(map=None,fig=None,rot=None,coord=None,unit='',
    ...
    See Also
    --------
    mollview, gnomview, cartview, lambview, azeqview
    """
    # Create the figure
    import pylab
    if not (hold or sub):
...
def lambview(map=None,fig=None,rot=None,zat=None,coord=None,unit='',
             xsize=800,ysize=None,reso=1.5,
             title='Lambert azimuthal equal-area view',nest=False,remove_dip=False,
             remove_mono=False,gal_cut=0,
             min=None,max=None,flip='astro',
             format='%.3g',cbar=True,
             cmap=None, norm=None,aspect=None,
    ...
    reso : float, optional
      Resolution (in arcmin). Default: 1.5 arcmin
    title : str, optional
      The title of the plot. Default: 'Lambert azimuthal equal-area view'
    nest : bool, optional
      If True, ordering scheme is NESTED. Default: False (RING)
    min : float, optional
      The minimum range value
    ...
    See Also
    --------
    mollview, gnomview, cartview, orthview, azeqview
    """
    # Create the figure
    import pylab
    if not (hold or sub):
...
def azeqview(map=None,fig=None,rot=None,zat=None,coord=None,unit='',
             xsize=800,ysize=None,reso=1.5,
             title='Azimuthal equidistant view',nest=False,remove_dip=False,
             remove_mono=False,gal_cut=0,
             min=None,max=None,flip='astro',
             format='%.3g',cbar=True,
             cmap=None, norm=None,aspect=None,
    ...
    See Also
    --------
    mollview, gnomview, cartview, orthview, lambview
    """
    # Create the figure
    import pylab
    if not (hold or sub):
    ...
    try:
        ...
        if remove_dip:
            ...
            map=pixelfunc.remove_monopole(map,gal_cut=gal_cut,nest=nest,
                                          copy=True,verbose=True)
        img = ax.projmap(map,nest=nest,xsize=xsize,ysize=ysize,reso=reso,lamb=False,
                         coord=coord,vmin=min,vmax=max,
                         cmap=cmap,norm=norm)
        if cbar:
            im = ax.get_images()[0]

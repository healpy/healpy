...
def process_generate_options(app):
    ...
    from myautosummary.generate import generate_autosummary_docs
    ...
    generate_autosummary_docs(genfiles, builder=app.builder,
                              ...
                              get_members=app.config['autosummary_get_members'])
...
def setup(app):
    ...
    app.add_config_value('autosummary_get_members', None, True)
